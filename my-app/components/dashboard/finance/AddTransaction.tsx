          ...
          <div className="mb-5 md:mb-6">
            ...
            <div className="grid grid-cols-2 gap-3 md:gap-4">
              <button
                ...
                className={`flex flex-col items-center justify-center p-3 md:p-6 rounded-lg border-2 transition-all ${
                  type === "income"
              ...
              >
                <div
                  className={`p-1.5 md:p-2 rounded-full ${
                    type === "income" ? "bg-yellow-100" : "bg-gray-100"
                  } mb-1.5 md:mb-2`}
                >
                  <Plus
                    className={`h-5 w-5 md:h-6 md:w-6 ${
                      type === "income" ? "text-yellow-600" : "text-gray-400"
                    }`}
                  />
                </div>
                <span
