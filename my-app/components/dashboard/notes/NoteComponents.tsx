    ...
    <div className="flex items-center gap-3 w-full md:w-auto">
      <div className="relative w-full md:w-64 group">
        ...
        <input 
          ...
          className="w-full pl-10 pr-4 py-2 bg-white border border-gray-200 rounded-lg text-gray-400 text-sm outline-none focus:border-amber-300 focus:ring-2 focus:ring-amber-100 transition-all shadow-sm"
        />
      </div>
